...
npm i -g neovim typescript typescript-language-server pyright vscode-langservers-extracted emmet-ls prettier @fsouza/prettierd eslint diagnostic-languageserver graphql-language-service-cli browser-sync
