...
-- LspDiagnostics
vim.cmd "hi! LspDiagnosticsSignError  ctermbg=none guibg=none guifg=#fb4934"
vim.cmd "hi! LspDiagnosticsSignWarning  ctermbg=none guibg=none guifg=#fabd2f"
vim.cmd "hi! LspDiagnosticsSignHint  ctermbg=none guibg=none guifg=#8ec07c"
